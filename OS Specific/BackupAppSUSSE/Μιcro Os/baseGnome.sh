...
#wanted apps
sudo tukit execute  -c  zypper  in fish grep nano  libfsapfs   make gcc      sed curl openssl       qemu virt-manager unrar   vncmanager xorg-x11-Xvnc-novnc  gamemoded neofetch
